...
const bookingValidationService_1 = require("./bookingValidationService");
describe('Booking Validation Service', () => {
    describe('canModifyBooking', () => {
        it('should allow modification for pending booking within window', () => {
            ...
            const result = (0, bookingValidationService_1.canModifyBooking)(booking);
    ...
    describe('calculateModificationDeadline', () => {
        it('should calculate deadline 8 hours from now', () => {
            const now = new Date();
            const deadline = (0, bookingValidationService_1.calculateModificationDeadline)(now);
        ...
        it('should default to current time if no timestamp provided', () => {
            const deadline = (0, bookingValidationService_1.calculateModificationDeadline)();
            const now = new Date();
            const expected = new Date(now.getTime() + 8 * 60 * 60 * 1000);
    ...
    describe('validateBookingDates', () => {
        it('should validate correct check-in and check-out dates', () => {
            ...
            const result = (0, bookingValidationService_1.validateBookingDates)(checkIn, checkOut);
