 ...
 */
router.get("/users", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 *         description: Forbidden - Admin only
 */
router.put("/promote-to-admin/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireSuperAdmin, [
 ...
 *         description: Forbidden - Admin only
 */
router.put("/demote-to-user/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireSuperAdmin, [
    (0, express_validator_1.check)("userId").isMongoId().withMessage("Invalid user ID")
], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
 ...
 *         description: Forbidden - Admin only
 */
router.get("/search-users", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.put("/verify-pwd/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireSuperAdmin, [
    (0, express_validator_1.check)("userId").isMongoId().withMessage("Invalid user ID"),
    (0, express_validator_1.check)("verified").isBoolean().withMessage("Verification status is required"),
], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
 ...
 *         description: Forbidden - Super Admin only
 */
router.put("/verify-account/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireSuperAdmin, [
    (0, express_validator_1.check)("userId").isMongoId().withMessage("Invalid user ID"),
    (0, express_validator_1.check)("verified").isBoolean().withMessage("Verification status is required"),
], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
 ...
 *         description: Forbidden - Super Admin only
 */
router.get("/users-pending-verification", role_based_auth_1.verifyToken, role_based_auth_1.requireSuperAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 *         description: Forbidden - Super Admin only
 */
router.get("/user-details/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireSuperAdmin, [
    (0, express_validator_1.check)("userId").isMongoId().withMessage("Invalid user ID")
], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
 ...
 *         description: User not found
 */
router.delete("/users/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, [
    (0, express_validator_1.check)("userId").isMongoId().withMessage("Invalid user ID")
], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
    ...
    try {
        ...
        const [bookingDeleteResult, hotelDeleteResult, promotionRequestDeleteResult] = yield Promise.all([
            booking_1.default.deleteMany({ userId }),
            hotel_1.default.deleteMany({ userId }),
            role_promotion_request_1.default.deleteMany({ userId })
        ]);
        // Delete the user
 ...
 *         description: User not found
 */
router.delete("/delete-user/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const user = yield user_1.default.findById(userId);
        if (!user) {
 ...
 *         description: User not found
 */
router.put("/toggle-user-status/:userId", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const user = yield user_1.default.findById(userId);
        if (!user) {
 ...
 *         description: Forbidden - Admin only
 */
router.get("/hotels", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
