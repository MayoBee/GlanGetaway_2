...
router.get("/all", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 10;
        const skip = (page - 1) * limit;
...
// Approve a resort
router.post("/:resortId/approve", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, [(0, express_validator_1.param)("resortId").notEmpty().withMessage("Resort ID is required")], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// Reject a resort
router.post("/:resortId/reject", role_based_auth_1.verifyToken, role_based_auth_1.requireAdmin, [
