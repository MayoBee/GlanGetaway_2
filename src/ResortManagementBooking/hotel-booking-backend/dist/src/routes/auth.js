...
const admin_access_control_1 = require("../middleware/admin-access-control");
 ...
 */
router.post("/login", loginRateLimiter, admin_access_control_1.restrictAdminToSubdirectory, [
    ...
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ userId: user._id.toString() }, process.env.JWT_SECRET_KEY, { expiresIn: "12h" });
