...
function addHorizonBeach() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const bienUser = yield db.collection('users').findOne({ email: 'biennickwadingan@gmail.com' });
            if (!bienUser) {
            ...
            // Insert the resort
            const result = yield db.collection('hotels').insertOne(horizonBeachResort);
...
exports.default = addHorizonBeach;
