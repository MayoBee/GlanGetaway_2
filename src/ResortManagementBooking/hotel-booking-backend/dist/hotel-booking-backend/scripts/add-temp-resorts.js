...
function addTempResorts() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const adminUser = yield db.collection('users').findOne({ email: 'admin@glangetaway.com' });
            const userId = ((_a = adminUser === null || adminUser === void 0 ? void 0 : adminUser._id) === null || _a === void 0 ? void 0 : _a.toString()) || 'admin_user_id';
            ...
            // Insert the resorts
            const result = yield db.collection('hotels').insertMany(tempResorts);
...
exports.default = addTempResorts;
