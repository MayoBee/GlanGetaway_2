...
router.get("/staff", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/staff", role_based_auth_1.verifyToken, [
    ...
    try {
        ...
        const user = new user_1.default({
            ...
            permissions: {
                ...
                canManageMaintenance: role === "housekeeping" || role === "resort_owner",
...
router.put("/staff/:id", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
router.delete("/staff/:id", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const user = yield user_1.default.findById(id);
        if (!user) {
...
// Get staff by ID
router.get("/staff/:id", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
