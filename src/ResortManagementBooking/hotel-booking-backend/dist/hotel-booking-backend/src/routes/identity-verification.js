...
router.post("/submit", verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingPending = yield identity_verification_1.default.findOne({
            guestId: userId,
 ...
 */
router.get("/status", verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.userId;
        const latestVerification = yield identity_verification_1.default.findOne({ guestId: userId })
            .sort({ createdAt: -1 });
        const user = yield user_1.default.findById(userId);
        res.json({
            accountVerified: (user === null || user === void 0 ? void 0 : user.accountVerified) || false,
            accountVerifiedAt: user === null || user === void 0 ? void 0 : user.accountVerifiedAt,
 ...
 */
router.get("/pending", verifyToken, verifyAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const pendingVerifications = yield identity_verification_1.default.find({
            verificationStatus: { $in: ["pending", "manual_review"] }
        }).sort({ createdAt: 1 });
        res.json({
 ...
 */
router.post("/:id/verify", verifyToken, verifyAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        const verification = yield identity_verification_1.default.findById(id);
        if (!verification) {
        ...
        yield user_1.default.findByIdAndUpdate(verification.guestId, {
 ...
 */
router.get("/:id", verifyToken, verifyAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const verification = yield identity_verification_1.default.findById(id);
        if (!verification) {
