...
router.get("/search", searchLimiter, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transformedHotels = hotels.map(hotel => {
            ...
            return Object.assign(Object.assign({}, hotelObj), { 
                // Handle both old and new field names
                imageUrls: hotelObj.imageUrls || (hotelObj.image ? [hotelObj.image] : []), starRating: hotelObj.starRating || hotelObj.rating || 0, 
...
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hotels = yield hotel_1.default.find({ isApproved: { $ne: false } })
            .select('name city country starRating type facilities imageUrls nightRate dayRate hasNightRate hasDayRate childEntranceFee isApproved')
            .sort("-lastUpdated");
        // Transform database fields to match frontend expectations for backward compatibility
        const transformedHotels = hotels.map(hotel => {
...
router.get("/:id", [(0, express_validator_1.param)("id").notEmpty().withMessage("Hotel ID is required")], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const hotel = yield hotel_1.default.findById(id).select('nightRate dayRate hasNightRate hasDayRate name rooms cottages packages childEntranceFee starRating adultCount childCount facilities contact policies imageUrls type city country description amenities gcashNumber downPaymentPercentage');
...
router.post("/:hotelId/bookings/payment-intent", auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const hotel = yield hotel_1.default.findById(hotelId).select('nightRate dayRate hasNightRate name rooms cottages childEntranceFee starRating adultCount childCount facilities contact policies imageUrls type city country description amenities').lean();
        if (!hotel) {
...
router.post("/:hotelId/bookings", auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const validation = timezoneUtils_1.TimezoneManager.validateBookingDates(checkIn, checkOut, clientTimezone);
        if (!validation.isValid) {
            return res.status(400).json({
                message: validation.error,
                timezone: timezoneUtils_1.TimezoneManager.getCurrentTimezone(),
        ...
        try {
            ...
            if (isEntranceFeeOnly) {
                ...
                booking = new booking_1.default(bookingData);
                yield booking.save();
                ...
                try {
                    const result = yield (0, availabilityService_1.createAtomicBooking)(bookingData, { session });
                    if (!result.success) {
