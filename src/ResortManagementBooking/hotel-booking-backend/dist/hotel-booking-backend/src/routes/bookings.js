...
const bookingValidationService_1 = require("../services/bookingValidationService");
const router = express_1.default.Router();
// Get all bookings (admin only)
router.get("/", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // Verify admin status
...
router.get("/hotel/:hotelId", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// Get booking by ID
router.get("/:id", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, bookingValidationService_1.checkAndUpdateBookingStatus)(booking);
...
router.delete("/:id", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.patch("/:id/verify-by-owner", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
router.patch("/:id/reschedule", auth_1.default, [
    ...
    const modificationCheck = (0, bookingValidationService_1.canModifyBooking)(booking);
...
router.patch("/:id/add-items", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
router.patch("/:id/remove-items", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
router.patch("/:id/gcash/verify", auth_1.default, (0, errorHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    ...
    if (status === "verified" && ((_d = booking.gcashPayment) === null || _d === void 0 ? void 0 : _d.referenceNumber)) {
        const existingPayment = yield booking_1.default.findOne({
            _id: { $ne: bookingId },
