...
router.get("/business-stats", auth_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            [totalUsers, totalResorts, totalBookings, bookings, users, resorts] = yield Promise.all([
        ...
        try {
            [prevUsers, prevResorts, prevBookings] = yield Promise.all([
        ...
        let prevRevenue = 0;
        try {
            prevRevenue = yield booking_1.default.aggregate([
        ...
        try {
            userDistribution = yield Promise.all([
        ...
        try {
            popularDestinations = yield booking_1.default.aggregate([
                { $match: { createdAt: { $gte: startDate, $lte: endDate } } },
                { $lookup: {
                        from: "hotels",
                        localField: "hotelId",
