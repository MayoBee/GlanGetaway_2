...
router.get("/", role_based_auth_1.verifyToken, (0, role_based_auth_1.requireRole)(["admin", "resort_owner", "front_desk"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const billings = yield billing_1.default.find(filter)
            .sort({ createdAt: -1 })
            .limit(Number(limit) * Number(page))
            .skip((Number(page) - 1) * Number(limit));
        const total = yield billing_1.default.countDocuments(filter);
        res.json({
            success: true,
            data: billings,
            pagination: {
...
router.get("/:id", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const billing = yield billing_1.default.findById(id);
        if (!billing) {
...
router.get("/booking/:bookingId", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { bookingId } = req.params;
        let billing = yield billing_1.default.findOne({ bookingId });
        if (!billing) {
...
router.post("/:id/charges", role_based_auth_1.verifyToken, (0, role_based_auth_1.requireRole)(["admin", "resort_owner", "front_desk"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
router.post("/:id/discounts", role_based_auth_1.verifyToken, (0, role_based_auth_1.requireRole)(["admin", "resort_owner", "front_desk"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        // Recalculate totals
        const subtotalBeforeDiscount = billing.roomCharges.reduce((sum, rc) => sum + rc.amount, 0) +
            billing.amenityCharges.reduce((sum, ac) => sum + ac.amount, 0) +
            billing.activityCharges.reduce((sum, ac) => sum + ac.amount, 0) +
            billing.serviceCharges.reduce((sum, sc) => sum + sc.amount, 0);
        const discountTotal = billing.discounts.reduce((sum, d) => sum + d.amount, 0);
...
// Process payment
router.post("/:id/payments", role_based_auth_1.verifyToken, (0, role_based_auth_1.requireRole)(["admin", "resort_owner", "front_desk"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
// Close folio
router.post("/:id/close", role_based_auth_1.verifyToken, (0, role_based_auth_1.requireRole)(["admin", "resort_owner", "front_desk"]), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        yield booking_1.default.findByIdAndUpdate(billing.bookingId, { status: "completed" });
        res.json({
            success: true,
...
// Generate receipt
router.get("/:id/receipt", role_based_auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const billing = yield billing_1.default.findById(id);
        if (!billing) {
