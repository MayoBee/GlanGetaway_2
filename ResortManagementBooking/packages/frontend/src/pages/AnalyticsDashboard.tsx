        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Comprehensive insights into your resort booking business
            </p>
          </div>
          <button
            onClick={() => refetch()}
        ...
        {activeTab === "overview" && analyticsData && (
          <div className="w-full space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 w-full">
              ...
              {/* Debug info */}
              <div className="text-xs text-gray-500 mb-2">
                Debug: {analyticsData.hotelPerformance.length} resorts found
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Total Resorts</span>
                    <span className="font-semibold">
