          ...
          <img
            ...
            onError={(e) => {
              ...
              if (parent) {
                ...
                fallback.className = 'w-full h-32 bg-gray-200 rounded-lg border border-gray-300 flex items-center justify-center text-gray-500 text-sm';
                fallback.innerHTML = `
                  <div class="text-center">
                    <div class="text-2xl mb-1">Image unavailable</div>
