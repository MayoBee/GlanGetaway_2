...
const SignIn = () => {
  ...
  const onSubmit = (data: SignInFormData) => {
    ...
    console.log('🔍 Mutation state before:', { isLoading: mutation.isLoading, isError: mutation.isError, error: mutation.error });
    ...
    // Direct form submission - bypass react-hook-form handleSubmit if needed
