...
const AdvancedSearch: React.FC<AdvancedSearchProps> = ({
  ...
  const [searchData, setSearchData] = useState({
    ...
    childAges: search.childAges || [] as number[],
    // Advanced filters
    minPrice: "",
    maxPrice: "",
    starRating: "",
  ...
  const handleInputChange = (field: string, value: any) => {
    setSearchData((prev) => {
      ...
      if (field === "childCount") {
        ...
        } else if (count < ages.length) {
          ages = ages.slice(0, count);
        }
        updated.childAges = ages;
      }
      return updated;
    });
  };
  ...
  // limit quick‑search options to Glan Saranggani barangays
  const popularDestinations = glanBarangays;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder="Select a Glan barangay"
          ...
          <div className="relative">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center border rounded overflow-hidden">
                <button
                  type="button"
                  onClick={() => handleInputChange("adultCount", Math.max(1, searchData.adultCount - 1))}
                  className="px-3 py-1 bg-gray-200 hover:bg-gray-300"
                >
                  -
                </button>
                <span className="px-4 py-1">{searchData.adultCount}</span>
                <button
                  type="button"
                  onClick={() => handleInputChange("adultCount", searchData.adultCount + 1)}
                  className="px-3 py-1 bg-gray-200 hover:bg-gray-300"
                >
                  +
                </button>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <div className="flex items-center border rounded overflow-hidden">
                <button
                  type="button"
                  onClick={() => handleInputChange("childCount", Math.max(0, searchData.childCount - 1))}
                  className="px-3 py-1 bg-gray-200 hover:bg-gray-300"
                >
                  -
                </button>
                <span className="px-4 py-1">{searchData.childCount}</span>
                <button
                  type="button"
                  onClick={() => handleInputChange("childCount", searchData.childCount + 1)}
                  className="px-3 py-1 bg-gray-200 hover:bg-gray-300"
                >
                  +
                </button>
            ...
            {searchData.childCount > 0 && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                {searchData.childAges.map((age, idx) => (
                  <div key={idx} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setSearchData((prev) => ({ ...prev, childAges: newAges }));
                      }}
