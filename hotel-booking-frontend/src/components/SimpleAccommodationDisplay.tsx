...
const SimpleAccommodationDisplay = ({ hotel, selectedRateType = 'night' }: any) => {
  ...
  console.log('=== SIMPLE ACCOMMODATION DEBUG ===');
  console.log('Hotel data:', hotel);
  console.log('Rooms found:', rooms, 'Count:', rooms.length);
  console.log('Cottages found:', cottages, 'Count:', cottages.length);
  console.log('Packages found:', packages, 'Count:', packages.length);
      ...
      {hasRooms && (
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Rooms ({rooms.length})</h3>
          </div>
      ...
      {hasCottages && (
        <div className="bg-white rounded-lg shadow-md p-6 mt-8">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Cottages ({cottages.length})</h3>
          </div>
              ...
              if (selectedRateType === 'day' && cottage.hasDayRate && cottage.dayRate) {
                ...
                rateDisplay = (
                  <div className="flex items-center justify-between p-2 border border-green-200 rounded bg-green-50">
                    ...
                    <span className="font-semibold">Day Rate: ₱{cottage.dayRate}</span>
                  </div>
                );
                ...
                rateDisplay = (
                  <div className="flex items-center justify-between p-2 border border-blue-200 rounded bg-blue-50">
                    ...
                    <span className="font-semibold">Night Rate: ₱{cottage.nightRate}</span>
                  </div>
                );
              }
      ...
      {hasPackages && (
        <div className="bg-white rounded-lg shadow-md p-6 mt-8">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Packages ({packages.length})</h3>
          </div>
...
export default SimpleAccommodationDisplay;
