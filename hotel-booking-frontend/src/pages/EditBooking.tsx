...
const EditBooking = () => {
  ...
  const calculateTotalPrice = () => {
    ...
    let totalPrice = hotel.nightRate * nights;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updatedBooking = {
        ...
        basePrice: hotel.nightRate,
      };

      await apiClient.updateBooking(booking._id, updatedBooking);
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium">₱{hotel.nightRate}/night</span>
                </div>
