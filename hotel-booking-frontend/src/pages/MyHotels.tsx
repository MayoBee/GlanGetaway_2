        ...
        <Card className="max-w-lg w-full">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl">My Resorts</CardTitle>
                <p className="text-sm text-muted-foreground mt-1">
                  Manage your beach resort listings and bookings
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-sm mb-4">
              <div className="flex items-center gap-2">
                ...
                <span>Sign in to view your resorts</span>
              </div>
              <div className="flex items-center gap-2">
    ...
    return (
      <div className="text-center py-12">
        <div className="bg-gray-50 rounded-2xl p-8 max-w-md mx-auto">
            <TreePalm className="w-16 h-16 text-gray-400 mx-auto mb-4" />
          <h3 className="text-xl font-semibold text-gray-600 mb-2">
            No Resorts Found
          </h3>
          <p className="text-gray-500 mb-6">
            You haven't added any resorts yet.
          </p>
          <Link
            to="/add-hotel"
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">My Resorts</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow-soft border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Total Resorts</p>
